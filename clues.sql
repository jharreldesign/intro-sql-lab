...
SELECT * FROM cities WHERE name = 'Oranjestad';

SELECT name, countrycode FROM cities WHERE name = 'Serra'
UNION
SELECT name, code AS population FROM countries WHERE code = 'BRA'
UNION
SELECT name, countrycode FROM cities WHERE name = 'Oranjestad' LIMIT 100
...
FROM cities
WHERE population BETWEEN 91084 AND 91086
